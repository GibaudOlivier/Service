CREATE TABLE Categorie (
	Code INT GENERATED BY DEFAULT AS IDENTITY (START WITH 9) NOT NULL PRIMARY KEY, 
...
CREATE TABLE Produit (
	Reference INT GENERATED BY DEFAULT AS IDENTITY (START WITH 78) NOT NULL PRIMARY KEY , 
...
CREATE TABLE Commande (
	Numero INT GENERATED BY DEFAULT  AS IDENTITY (START WITH 11078) NOT NULL PRIMARY KEY, 
	Client CHAR(5) NOT NULL REFERENCES Client (Code) ON DELETE CASCADE, 
	SaisieLe DATE default CURRENT_DATE NOT NULL, 
	EnvoyeeLe DATE default NULL, 
